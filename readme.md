...
هذا البرنامج يعمل بالكامل بدون إنترنت.
...
# الميزات الإضافية
- عرض الوقت المتبقي لأقرب صلاة.
- التحويل لصلاة الفجر للغد مباشرة بعد صلاة العشاء.
- يمكن الضغظ على توقيت أي صلاة لعرض الوقت المتبقي أو الفائت لها.
